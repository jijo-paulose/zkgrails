 ...
 * @since Apr 19, 2006
 */
public class ZKGrailsPageFilter extends PageFilter {
    ...
    public void doFilter(ServletRequest rq, ServletResponse rs, FilterChain chain)
        ...
        // System.out.println(">>> " + extractRequestPath(request));

        if (rq.getAttribute(FILTER_APPLIED) != null || factory.isPathExcluded(extractRequestPath(request)) || isZK(request)) {
